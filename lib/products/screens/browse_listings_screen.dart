...
class BrowseListingsScreen extends StatefulWidget {
  ...
  @override
  State<BrowseListingsScreen> createState() =>
      _BrowseListingsScreenState();
}

class _BrowseListingsScreenState
    extends State<BrowseListingsScreen> {
  ...
  static const Duration _snackbarCooldown =
  Duration(seconds: 2);
              ...
              child: Padding(
                ...
                child: BlocBuilder<
                  ...
                  builder: (context, state) {
                    ...
                    filteredActive
                        .take(
                      _visibleProductsCount,
                    )
                        .toList();

                    final recommendedListings =
                    _smartService
